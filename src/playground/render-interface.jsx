...
import ExampleProjects from '../components/tw-example-projects/example-projects.jsx';
...
const GUIDE_SEEN_STORAGE_KEY = 'scratch-gui-guide-seen';
        ...
        <div className={styles.footerContent}>
            <div className={styles.footerText}>
                <FormattedMessage
                    ...
                    description="Disclaimer that CapivaraMod is not connected to Scratch"
            ...
            <div className={styles.footerColumns}>
                ...
                <div className={styles.footerSection}>
                    <a href="https://capivaramod.github.io/packager/">
                        {/* Do not translate */}
                ...
                <div className={styles.footerSection}>
                    ...
                    <a href="https://github.com/CapivaraMod/">
                        <FormattedMessage
...
class Interface extends React.Component {
    constructor (props) {
        super(props);
        const firstVisit = !window.localStorage.getItem(GUIDE_SEEN_STORAGE_KEY);
        if (firstVisit) {
            window.localStorage.setItem(GUIDE_SEEN_STORAGE_KEY, 'true');
        }
        this.state = {
            guideVisible: firstVisit
        };
        this.handleUpdateProjectTitle = this.handleUpdateProjectTitle.bind(this);
        this.handleToggleGuide = this.handleToggleGuide.bind(this);
    ...
    handleToggleGuide () {
        this.setState(prevState => ({
            guideVisible: !prevState.guideVisible
        }));
    }
    handleCloseGuide () {
                ...
                {isHomepage ? (
                    <div className={styles.menu}>
                        <WrappedMenuBar
                            ...
                            onToggleGuide={this.handleToggleGuide}
                        />
                    </div>
                ) : null}
                {isHomepage && this.state.guideVisible ? (
                    <Guide onClose={this.handleCloseGuide} />
                ) : null}
                <div
