...
const wikipedia = function (isInitialSetup, isStage, targetId, colors) {
    const term = translate('WIKIPEDIA_TERM_TEXT', 'capivara');
    // Fallback colors in case the active theme doesn't define a "wikipedia" entry.
    const wikipediaColors = colors || {primary: '#5FA85B', tertiary: '#4C8A49'};
    // Note: the category's secondaryColour matches up with the blocks' tertiary color, both used for border color.
    return `
    <category
        name="%{BKY_CATEGORY_WIKIPEDIA}"
        id="wikipedia"
        colour="${wikipediaColors.primary}"
        secondaryColour="${wikipediaColors.tertiary}">
        <block id="wikipedia_set_language" type="wikipedia_set_language">
            <value name="LANGUAGE">
                <shadow type="wikipedia_languages_menu"/>
            </value>
        </block>
        ${blockSeparator}
        <block id="wikipedia_page_exists" type="wikipedia_page_exists">
            <value name="TERM">
                <shadow type="text">
                    <field name="TEXT">${term}</field>
                </shadow>
            </value>
        </block>
        ${blockSeparator}
        <block id="wikipedia_summary" type="wikipedia_summary">
            <value name="TERM">
                <shadow type="text">
                    <field name="TEXT">${term}</field>
                </shadow>
        ...
        <block id="wikipedia_description" type="wikipedia_description">
            <value name="TERM">
                <shadow type="text">
                    <field name="TEXT">${term}</field>
                </shadow>
        ...
        <block id="wikipedia_title" type="wikipedia_title">
            <value name="TERM">
                <shadow type="text">
                    <field name="TEXT">${term}</field>
                </shadow>
        ...
        <block id="wikipedia_image" type="wikipedia_image">
            <value name="TERM">
                <shadow type="text">
                    <field name="TEXT">${term}</field>
                </shadow>
        ...
        <block id="wikipedia_link" type="wikipedia_link">
            <value name="TERM">
                <shadow type="text">
                    <field name="TEXT">${term}</field>
                </shadow>
        ...
        ${blockSeparator}
        <block id="wikipedia_clear_cache" type="wikipedia_clear_cache"/>
        ${categorySeparator}
    </category>
    `;
};
...
const makeToolboxXML = function (isInitialSetup, isStage = true, targetId, categoriesXML = [],
    ...
    const wikipediaXML = moveCategory('wikipedia') ||
        wikipedia(isInitialSetup, isStage, targetId, colors.wikipedia);
