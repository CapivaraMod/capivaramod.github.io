                ...
                <div className={styles.mainMenu}>
                                    ...
                                    {this.props.onClickPackager && (
                                        <MenuSection>
                                            ...
                                            <MenuItem
                                                onClick={() =>
                                                    window.open(
                                                        `https://capivaramod.github.io/unpackager`
                                                    )
                                                }
                                            >
                                                <FormattedMessage
                                                    defaultMessage="Unpackager"
                                                    description="Menu bar item to open the capivaramod unpackager"
                    ...
                    <div className={classNames(styles.menuBarItem)}>
                        <Button
                            ...
                            onClick={this.props.onToggleGuide}
                        >
                            {'?'}
                            <span className={styles.guideButtonLabel}>{'Guia'}</span>
                        </Button>
                    </div>
                    {this.props.canShare ? (
